#include "menu.h"
void menu::GameMenu::setInitText(sf::Text& text, sf::String str, float xpos, float ypos)
{
	text.setFont(font);       
...
void menu::InitText(sf::Text& mtext, float xpos, float ypos, sf::String str, int size_font,
...
void menu::GameMenu::AlignMenu(int posx)
{
	float nullx = 0;
...
// ???????????
menu::GameMenu::GameMenu(sf::RenderWindow& window, float menux, float menuy,
...
void menu::GameMenu::setColorTextMenu(sf::Color menColor, sf::Color ChoColor, sf::Color BordColor)
{
